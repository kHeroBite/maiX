...
public partial class CalendarViewModel : ViewModelBase
{
    ...
    [RelayCommand]
    public async Task CreateDeadlineEventAsync(MailXEmail email)
    {
    ...
    [RelayCommand]
    public async Task CreateEventFromTodoAsync(MailXTodo todo)
    {
        if (todo == null)
            return;
    ...
    [RelayCommand]
    public async Task<MailXMeetingInfo?> ParseMeetingInviteAsync(string eventId)
    {
