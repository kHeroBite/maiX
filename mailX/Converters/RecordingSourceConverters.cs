...
/// mailX: 파란색, External: 회색
/// </summary>
public class RecordingSourceToBackgroundConverter : IValueConverter
{
    private static readonly SolidColorBrush MailXBrush = new(Color.FromRgb(0, 120, 212));  // #0078D4
    ...
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
        ...
        {
            return source == RecordingSource.MailX ? MailXBrush : ExternalBrush;
        }
