 ...
 * - 스레드 안전한 로깅
 *
 * 로그 저장 경로: %APPDATA%\mailX\logs\yyyyMMdd.log
 */
...
public static class Log4
{
    ...
    public static void Initialize()
    {
        try
        {
            ...
            string logPath = Path.Combine(appDataPath, "mailX", "logs");
