...
public class SpeechRecognitionService : IDisposable
{
    ...
    private static readonly string ModelsDir = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "MaiX", "models", "sherpa-onnx");

    private static readonly string WhisperModelsDir = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "MaiX", "models", "whisper");
