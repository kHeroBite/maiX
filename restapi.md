...
MaiX 애플리케이션의 REST API는 5858 포트에서 실행되는 HTTP 서버로, 외부에서 프로그램을 제어하고 테스트 자동화를 지원합니다.
...
### 소스 파일
- `MaiX/Services/Api/RestApiServer.cs`
...
```json
{
  ...
  "filePath": "C:\\Users\\{user}\\AppData\\Roaming\\MaiX\\screenshots\\screenshot_20260113_153045.png",
  "capturedAt": "2026-01-13 15:30:45"
}
```

**저장 경로**: `%APPDATA%\MaiX\screenshots\screenshot_{yyyyMMdd_HHmmss}.png`
...
{
  "lines": 50,
  "logPath": "C:\\Users\\{user}\\AppData\\Roaming\\MaiX\\logs\\20260113.log",
  "logs": [
...
```json
{
  ...
  "path": "C:\\Users\\{user}\\AppData\\Roaming\\MaiX\\logs\\20260113.log"
}
```
...
MaiX 프로젝트에서는 모든 코드 변경 후 다음 3단계 테스트를 **순서대로 모두 통과**해야 합니다.
